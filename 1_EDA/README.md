...
![EDA Project Overview](../Images/877ff55a-5e4a-45a5-acae-aa928ca6e89e.png)
...
1. [`01_top_demanded_skills.sql`](01_top_demand_skills.sql) - demand analysis with multi-table joins
2. [`02_top_paying_skills.sql`](./02_top_paying_skills.sql) - salary analysis with aggregations
3. [`03_optimal_skill.sql`](./03_optimal_skills.sql) - combined demand/salary optimization query
...
1. **[`Top Demand Skills`](./01_top_demand_skills.sql)** - Identifies the 10 most in-demand skills for remote data engineer positions.
